...
pyspu::wrapper::wrap_sink(py::handle scope)
{
    ...
    lB::for_each(
      [&](auto b)
      {
          ...
          auto sink_class = py::class_<spu::module::Sink<B>, spu::module::Stateful, spu::tools::Interface_reset>(
...
#include "wrapper/Module/Stateful/Sink/NO/Sink_NO.hpp"
#include "wrapper/Module/Stateful/Sink/User/Sink_user_binary.hpp"
void
