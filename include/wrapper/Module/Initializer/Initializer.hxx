...
void wrap_initializer_internal(py::handle scope, const std::string& name)
{
    ...
    py_initializer_class.def("get_init_data", &aff3ct::module::Initializer<T>::get_init_data);
    ...
    py_initializer_class.def_property_readonly("data_init", [](const aff3ct::module::Initializer<T>& self){
