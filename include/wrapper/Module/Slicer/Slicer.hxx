...
namespace module
{
	...
	::_task_init()
	{
		...
		this->create_codelet(p, [ps_x, ps_nx](spu::module::Module &m, spu::runtime::Task &t, const size_t frame_id) -> int
		{
		...
		this->create_codelet(p1, [p1s_x, p1s_nx](spu::module::Module &m, spu::runtime::Task &t, const size_t frame_id) -> int
		{
			auto &slicer = static_cast<Slicer&>(m);
		...
		this->create_codelet(p2, [p2s_x, p2s_xs](spu::module::Module &m, spu::runtime::Task &t, const size_t frame_id) -> int
		{
			auto &slicer = static_cast<Slicer&>(m);
