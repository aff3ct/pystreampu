...
{
    auto py_controller_cyclic_class = py::class_<spu::module::Controller_cyclic, spu::module::Controller>(scope, "Controller_cyclic");
    ...
    py_controller_cyclic_class.def_property("path", &spu::module::Controller_cyclic::get_path, &spu::module::Controller_cyclic::set_path);
