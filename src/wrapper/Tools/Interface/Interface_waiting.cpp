...
void
pyspu::wrapper::wrap_interface_waiting(py::module_& scope)
{
    auto itf_class =
      py::class_<spu::tools::Interface_waiting, spu::tools::Interface_reset, pyspu::wrapper::py_Interface_waiting>(
