...
void pyaf::wrapper::wrap_signal_handler(py::module_& scope)
{
	...
	signal_handler_class.def_property_readonly_static("sigint", &spu::tools::Signal_handler::is_sigint);
    signal_handler_class.def_property_readonly_static("sigsegv", &spu::tools::Signal_handler::is_sigsegv);
