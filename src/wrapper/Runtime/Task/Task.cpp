...
void pyaf::wrapper::wrap_task(py::handle scope) {
  ...
  py_task.def(
      "exec",
      [](spu::runtime::Task &self, const int frame_id,
  ...
  py_task.def_property("debug", &spu::runtime::Task::is_debug,
                       &spu::runtime::Task::set_debug);
  py_task.def_property("stats", &spu::runtime::Task::is_stats,
                       &spu::runtime::Task::set_stats);
  py_task.def_property("fast", &spu::runtime::Task::is_fast,
                       &spu::runtime::Task::set_fast);
  py_task.def_property_readonly("n_calls", &spu::runtime::Task::get_n_calls);
  py_task.def_property_readonly(
      "total_duration", [](const spu::runtime::Task &self) {
        if (self.is_stats())
          return std::chrono::duration<double>(self.get_duration_total())
              .count();
        else
          return double(0.0f);
      });
  py_task.def_property_readonly(
      "avg_duration", [](const spu::runtime::Task &self) {
        if (self.is_stats())
  ...
  py_task.def_property_readonly(
      "min_duration", [](const spu::runtime::Task &self) {
        if (self.is_stats())
  ...
  py_task.def_property_readonly(
      "max_duration", [](const spu::runtime::Task &self) {
        if (self.is_stats())
  ...
  py_task.def(
      "bind",
      [](spu::runtime::Task &self, spu::runtime::Socket &s_out,
         const int priority) { self.bind(s_out, priority); },
      "Binds the Task to socket 's_out' with priority 'priority'.", "s_out"_a,
      "priority"_a = -1);
  py_task.def(
      "bind",
      [](spu::runtime::Task &self, spu::runtime::Task &t_out,
         const int priority) { self.bind(t_out, priority); },
      "Binds the Task to task 't_out' with priority 'priority'.", "t_out"_a,
      "priority"_a = -1);

  // py_task.def("is_bound"           , &spu::runtime::Task::is_bound );
  py_task.def("set_debug_hex", &spu::runtime::Task::set_debug_hex,
              "debug_hex"_a);
  py_task.def("set_debug_limit", &spu::runtime::Task::set_debug_limit,
              "limit"_a);
  py_task.def("set_debug_precision", &spu::runtime::Task::set_debug_precision,
              "prec"_a);
  py_task.def("set_debug_frame_max", &spu::runtime::Task::set_debug_frame_max,
              "limit"_a);
};
