...
void pyaf::wrapper::wrap_exceptions(py::module_ &scope) {
  ...
  py::register_exception<spu::tools::control_flow_error>(scope,
                                                         "ControlFlowError");
  py::register_exception<spu::tools::domain_error>(scope, "DomainError");
  py::register_exception<spu::tools::invalid_argument>(scope,
                                                       "InvalidArgument");
  ...
  py::register_exception<spu::tools::processing_aborted>(scope,
                                                         "ProcessingAborted");
  ...
  py::register_exception<spu::tools::unimplemented_error>(scope,
                                                          "UnimplementedError");
  py::register_exception<spu::tools::waiting_canceled>(scope,
                                                       "WaitingCanceled");
}