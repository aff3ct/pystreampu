...
PYBIND11_MODULE(_ext, m) {
  ...
  // Interfaces
  py::module_ submod_itf =
      m.def_submodule("interfaces"); // TODO : put in a separate file
  ...
  pyaf::wrapper::wrap_source_random(
      submod_src);                             // TODO : put in a separate file
  pyaf::wrapper::wrap_source_user(submod_src); // TODO : put in a separate file
  pyaf::wrapper::wrap_source_user_binary(
      submod_src); // TODO : put in a separate file
