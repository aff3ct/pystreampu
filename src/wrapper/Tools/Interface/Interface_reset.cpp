...
{
	auto itf_class = py::class_<aff3ct::tools::Interface_reset, pyaf::wrapper::py_Interface_reset, std::shared_ptr<aff3ct::tools::Interface_reset>>(scope, "Interface_reset");
