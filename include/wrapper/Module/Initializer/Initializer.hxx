...
void wrap_initializer_internal(py::handle scope, const std::string &name) {
  ...
  auto py_initializer_class =
      py::class_<spu::module::Initializer<T>, spu::module::Module>(
          scope, name.c_str());
  py_initializer_class.def(py::init<const size_t>(), "n_elmts"_a, doc_str,
                           py::return_value_policy::take_ownership);
  py_initializer_class.def("get_init_data",
                           &spu::module::Initializer<T>::get_init_data);
  ...
  py_initializer_class.def_property_readonly(
      "data_init", [](const spu::module::Initializer<T> &self) {
  ...
  py_initializer_class.def_property("n_frames",
                                    &spu::module::Initializer<T>::get_n_frames,
                                    &spu::module::Initializer<T>::set_n_frames);
}
